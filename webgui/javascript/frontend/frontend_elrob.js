...
function button_emstop_change(pressed) {
    ...
    let btn = document.getElementById("button_emstop");
    if (btn == null) {
        return;
    }
...
function button_log_onclick() {
    switch (document.getElementById("select_tag").value) {
        case "thermal":
            logger.set_waypoint("/l3xz/thermal_recorder/set_waypoint", "thermal");
            break;
        case "radiation":
            logger.set_waypoint("/l3xz/radiation_recorder/set_waypoint", "radiation");
            break;
        case "other":
            logger.set_waypoint("/l3xz/other_recorder/set_waypoint", "radiation");
            break;
        default:
            console.log("tag not implemented");
            break;
    }
}
