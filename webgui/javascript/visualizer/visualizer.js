    ...
    show(name, type, message) {
        ...
        switch (type) {
            case "sensor_msgs/LaserScan":
                this.showLaserScan(name, type, message);
                break;
            case "diagnostic_msgs/DiagnosticStatus":
                this.showDiagnosticStatus(name, type, message);
                break;
            case "msgs/filteroutput":
                this.showFilter(name, type, message);
                break;
                //case "sensor_msgs/Image": this.showImage(name, type, message); break;
            case "sensor_msgs/CompressedImage":
                this.showCompressedImage(name, type, message);
                break;
            ...
            case "std_msgs/Float64MultiArray":
                ...
                break;
            case "std_msgs/Int8":
                this.showInt(name, type, message);
                break;
            case "std_msgs/Int16":
                this.showInt(name, type, message);
                break;
            ...
            case "geometry_msgs/Twist":
                this.showTwist(name, type, message);
                break;
            ...
            case "nav_msgs/OccupancyGrid":
                this.showGrid(name, type, message);
                break;
            default:
                this.showNotImplemented(name, type, message);
                break;
